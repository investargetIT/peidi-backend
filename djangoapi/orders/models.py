...
class salesOutDetails(models.Model):
    ...
    post_amount = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True, verbose_name='订单邮费')
    share_post_amount = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True, verbose_name='分摊邮费')
    deal_price = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True, verbose_name='分摊后单价')
    deal_total_price = models.DecimalField(max_digits=19, decimal_places=4, blank=True, null=True, verbose_name='分摊后总价')
...
class ExchangeManagement(models.Model):
    ...
    original_exchange_no = models.CharField(max_length=512, blank=True, null=True, verbose_name='原始退换单号')
...
class ShopTarget(models.Model):
    ...
    org = models.CharField(max_length=40, blank=True, null=True, verbose_name='组织')
    team = models.CharField(max_length=40, blank=True, null=True, verbose_name='团队')
    salesman = models.CharField(max_length=40, blank=True, null=True, verbose_name='业务员')
