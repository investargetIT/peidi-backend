...
class orders(models.Model):
    ...
    trade_time = models.DateTimeField(blank=True, null=True, help_text='下单时间', verbose_name='下单时间')
    pay_time = models.DateTimeField(blank=True, null=True, help_text='支付时间', verbose_name='支付时间')
    end_time = models.DateTimeField(blank=True, null=True, help_text='结束时间', verbose_name='结束时间')
    ...
    to_deliver_time = models.DateTimeField(blank=True, null=True, help_text='送货时间', verbose_name='送货时间')
    ...
    payer_name = models.CharField(max_length=255, blank=True, null=True, verbose_name='对应发票抬头，付款方名称')
    ...
    modified = models.DateTimeField(blank=True, null=True, help_text='修改时间', verbose_name='修改时间')
    created = models.DateTimeField(blank=True, null=True, help_text='创建时间', verbose_name='创建时间')
