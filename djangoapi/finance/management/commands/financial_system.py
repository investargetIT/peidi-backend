...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # self.invoice_created_by_ali("2024-06-26", "2024-07-25")

        # self.invoice_created_manually("2024-06-26", "2024-07-25")

        # self.invoice_summary('2024-06-26', '2024-07-25')

        # self.extend_douyin_refund("2024-06-26", "2024-07-25")

        # self.extend_jd_refund("2024-06-26", "2024-07-25")

        # self.extend_pdd_refund("2024-06-26", "2024-07-25")

        # self.extend_tmall_refund("2024-06-26", "2024-07-25")

        # self.refund_summary("2024-06-26", "2024-07-25")

        # self.sales_summary("2024-06-26", "2024-07-25")

        # self.overall_summary("2024-06-26", "2024-07-25")
